...
{
    public class ColorDispatchFrontsReportToDbf
    {
        ...
        public ColorDispatchFrontsReportToDbf(FrontsCatalogOrder FrontsCatalogOrder, DecorCatalogOrder DecorCatalogOrder)
        {
