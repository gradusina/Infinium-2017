...
namespace Infinium.Modules.Marketing.NewOrders.PrepareReport.ColorInvoiceReportToDBF
{
    public class ColorInvoiceReportToDBF
    {
            ...
            decimal TotalCost, int CurrencyTypeID, decimal TotalWeight, bool IsSample, ref decimal TotalProfil1, ref decimal TotalTPS1)
        {
            ...
            using (SqlDataAdapter DA = new SqlDataAdapter(@"SELECT PackageDetails.PackNumber, infiniu2_catalog.dbo.TechStore.Cvet, infiniu2_catalog.dbo.Patina.Patina, infiniu2_catalog.dbo.FrontsConfig.InvNumber, infiniu2_catalog.dbo.FrontsConfig.FactoryID, NewFrontsOrders.MainOrderID
                FROM PackageDetails INNER JOIN
                NewFrontsOrders ON PackageDetails.OrderID = NewFrontsOrders.FrontsOrdersID INNER JOIN
                infiniu2_catalog.dbo.FrontsConfig ON NewFrontsOrders.FrontConfigID = infiniu2_catalog.dbo.FrontsConfig.FrontConfigID LEFT JOIN
            ...
            sheet1.SetColumnWidth(displayIndex++, 71 * 256);
