...
namespace Infinium.Modules.Marketing.Orders.InvoiceReportToDbf
{
    public class InvoiceFrontsReportToDbf
    {
        ...
        private Orders.FrontsCatalogOrder frontsCatalogOrder;
        private Orders.DecorCatalogOrder decorCatalogOrder;

        public InvoiceFrontsReportToDbf(Orders.FrontsCatalogOrder FrontsCatalogOrder, Orders.DecorCatalogOrder DecorCatalogOrder)
        {
