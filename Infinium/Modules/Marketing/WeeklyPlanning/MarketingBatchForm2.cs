...
namespace Infinium
{
    public partial class MarketingBatchForm2 : Form
    {
        ...
        private void Initialize()
        {
            ...
            monthCalendar1.TodayDate = DateTime.Today.AddDays(-90);
            monthCalendar1.SelectionStart = DateTime.Today.AddDays(-90);
        ...
        private void Filter()
        {
            ...
            if (_needSplash)
            {
                ...
                BatchManager.Filter_MegaBatches_ByFactory(_factoryId, firstDate, secondDate);
        ...
        private void AddMegaBatchButton_Click(object sender, EventArgs e)
        {
            ...
            BatchManager.AddMegaBatch(_factoryId, monthCalendar1.SelectionStart, monthCalendar2.SelectionStart);
        }
        ...
        private void OKMoveBatchButton_Click(object sender, EventArgs e)
        {
            ...
            BatchManager.MoveBatch(batch, destMegaBatchId, _factoryId, monthCalendar1.SelectionStart, monthCalendar2.SelectionStart);
        ...
        private void SaveMegaBatch_Click(object sender, EventArgs e)
        {
            if (MegaBatchDataGrid.SelectedRows.Count == 1)
            {
                ...
                BatchManager.SaveMegaBatch(_factoryId, firstDate, secondDate);
            }
        }
