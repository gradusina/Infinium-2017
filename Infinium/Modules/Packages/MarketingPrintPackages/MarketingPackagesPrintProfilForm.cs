...
namespace Infinium
{
    public partial class MarketingPackagesPrintProfilForm : Form
    {
        ...
        private const int FactoryID = 1;//ТПС
        private const int BarcodeType = 3;//Упаковка. ЗОВ. ТПС

        private int FormEvent = 0;
        private int CurrentRowIndex = 0;
        private int CurrentColumnIndex = 0;
        private int CurrentPackNumber = 0;
        private int LanguageParam = 0;
        ...
        private MarketingFilterProductsForm MarketingFilterProductsForm;
