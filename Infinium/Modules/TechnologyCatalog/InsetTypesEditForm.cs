...
namespace Infinium
{
    public partial class InsetTypesEditForm : Form
    {
        ...
        private DataTable dtInsetTypes;
        ...
        public InsetTypesEditForm(Form tMainForm)
        {
            MainForm = tMainForm;
            InitializeComponent();
            ...
            //    dtInsetTypes.Rows.Add(NewRow);
            //}
            dgvInsetTypes.AllowUserToAddRows = true;
        ...
        private void btnSaveInsetGroups_Click(object sender, EventArgs e)
        {
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM InsetGroups ORDER BY GroupName",
                ConnectionStrings.CatalogConnectionString))
            {
