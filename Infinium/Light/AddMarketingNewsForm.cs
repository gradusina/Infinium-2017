...
namespace Infinium
{
    ...
    {
        private MarketingNews LightNews;
        ...
        public AddMarketingNewsForm(ref MarketingNews tLightNews, ref Form tTopForm)
        {
            InitializeComponent();
        ...
        public AddMarketingNewsForm(ref MarketingNews tLightNews, int SenderTypeID, string HeaderText, string BodyText, int iNewsID, DateTime dDateTime, ref Form tTopForm)
        {
            InitializeComponent();
