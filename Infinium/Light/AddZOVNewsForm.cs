...
namespace Infinium
{
    public partial class AddZOVNewsForm : Form
    {
        ...
        public AddZOVNewsForm(ref ZOVNews tLightNews, ref Form tTopForm)
        {
            InitializeComponent();
        ...
        public AddZOVNewsForm(ref ZOVNews tLightNews, int SenderTypeID, string HeaderText, string BodyText, int iNewsID, DateTime dDateTime, ref Form tTopForm)
        {
            InitializeComponent();
