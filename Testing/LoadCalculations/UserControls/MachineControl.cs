...
namespace Infinium.Catalog.UserControls
{
    public partial class MachineControl : UserControl
    {
        ...
        public void Clear()
        {
            dgvCalculations.DataSource = null;
            dgvNotConfirmed.DataSource = null;
            dgvForAgreed.DataSource = null;
            dgvAgreed.DataSource = null;
            dgvOnProduction.DataSource = null;
            dgvInProduction.DataSource = null;
        }
        ...
        {
            if (dgvInProduction.DataSource == null || dgvInProduction.Rows.Count - 1 < firstDisplayedScrollingRowIndex)
                return;
            try
            {
        ...
        {
            if (dgvNotConfirmed.DataSource == null || dgvNotConfirmed.Rows.Count - 1 < selectedRowIndex)
                return;
            try
            {
        ...
        {
            if (dgvForAgreed.DataSource == null || dgvForAgreed.Rows.Count - 1 < selectedRowIndex)
                return;
            try
            {
        ...
        {
            if (dgvAgreed.DataSource == null || dgvAgreed.Rows.Count - 1 < selectedRowIndex)
                return;
            try
            {
        ...
        {
            if (dgvOnProduction.DataSource == null || dgvOnProduction.Rows.Count - 1 < selectedRowIndex)
                return;
            try
            {
        ...
        {
            if (dgvInProduction.DataSource == null || dgvInProduction.Rows.Count - 1 < selectedRowIndex)
                return;
            try
            {
